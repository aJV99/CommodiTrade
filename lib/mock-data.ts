...
export const mockTrades: Trade[] = [
  ...
  },
  {
    ...
    price: 2034.7,
    totalValue: 203470,
    counterparty: "Precious Metals Inc",
    status: "Settled",
  ...
  },
  {
    ...
    price: 3.89,
    totalValue: 7780,
    counterparty: "Industrial Metals Co",
    status: "Executed",
...
export const mockShipments: Shipment[] = [
  ...
  },
  {
    ...
    carrier: "Secure Transport",
    trackingNumber: "ST789012",
  },
  {
    id: "S003",
    tradeId: "T004",
...
export const mockCounterparties: Counterparty[] = [
  ...
  },
  {
    ...
    totalTrades: 23,
    totalVolume: 5000,
    lastTradeDate: "2024-01-13",
    contactPerson: "David Brown",
    email: "david@preciousmetals.co.uk",
  ...
  },
  {
    ...
    email: "hans@industrialmetals.de",
  ...
  },
  {
    ...
    totalTrades: 28,
    totalVolume: 18000,
    lastTradeDate: "2024-01-11",
    contactPerson: "Marie Dubois",
    email: "marie@agripartners.ca",
...
export async function getDashboardStats() {
  return Promise.resolve({
    ...
    totalInventoryValue: mockInventory.reduce(
      (sum, item) => sum + item.quantity * item.marketValue,
      0,
    ),
    pendingShipments: mockShipments.filter((s) => s.status !== "Delivered")
      .length,
