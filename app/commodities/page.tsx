      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 mt-2">
            Manage available commodities and prices
          </p>
        </div>
              ...
              <tbody>
                {filtered.map((commodity: any) => (
                  <tr
                    ...
                    onClick={() =>
                      (window.location.href = `/commodities/${commodity.id}`)
                    }
                  >
                    ...
                    <td
                      className={`py-3 px-4 font-medium ${commodity.priceChange >= 0 ? "text-green-600" : "text-red-600"}`}
                    >
