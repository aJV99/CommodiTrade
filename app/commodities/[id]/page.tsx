      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          ...
          <Button
            ...
            size="sm"
            onClick={async () => {
              const val = window.prompt('Enter new price', commodity.currentPrice.toString());
              if (!val) return;
              const newPrice = parseFloat(val);
              if (isNaN(newPrice)) return;
              await updatePriceMutation.mutateAsync({ commodityId: id, newPrice });
              refetch();
            }}
          >
            Update Price
          ...
          <Button
            ...
            onClick={async () => {
              if (confirm('Delete this commodity?')) {
                await deleteCommodityMutation.mutateAsync(id);
